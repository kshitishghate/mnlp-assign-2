...
def preprocess_data(args):
    ...
    return common_voice_train, common_voice_test, processor
...
def train(args, common_voice_train,common_voice_test, processor):
...
if __name__ == "__main__":
    ...
    common_voice_train, common_voice_test, processor = preprocess_data(args)

    print("Fine-tuning model")
    train(args, common_voice_train,common_voice_test, processor)
